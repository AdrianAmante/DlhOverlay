jQuery(document).ready(function($){
	...
	// var step1 = $('#step-1.cd-single-step');
	// var pos = step1.position();
	...
	// 	console.log(res2);
		...
		// $('.cd-single-step[_ngcontent-c5]:nth-of-type(1)').text(1)
	})
	...
	function createNavigation(steps, n) {
		var tourNavigationHtml = '<div class="cd-nav"><span><b class="cd-actual-step">1</b> of '+n+'</span><ul class="cd-tour-nav"><li><a href="javascript:void(0)" class="cd-prev">&#171; Previous</a></li><li><a href="javascript:void(0)" class="cd-next">Next &#187;</a></li></ul></div><a href="javascript:void(0)" class="cd-close">Close</a>';
